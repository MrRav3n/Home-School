...
/* harmony import */ var _components_models_show_members_show_members_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./components/models/show-members/show-members.component */ "./src/app/components/models/show-members/show-members.component.ts");
/* harmony import */ var _components_classrom_text_chat_text_chat_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/classrom/text-chat/text-chat.component */ "./src/app/components/classrom/text-chat/text-chat.component.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_models_show_members_show_members_component__WEBPACK_IMPORTED_MODULE_32__["ShowMembersComponent"],
...
let ClassromComponent = class ClassromComponent {
    constructor(main, route, shared, classService) {
        this.main = main;
        this.route = route;
        this.shared = shared;
...
let HomeworkFinishedComponent = class HomeworkFinishedComponent {
    constructor(main, classService, shared) {
        this.main = main;
        this.classService = classService;
        this.shared = shared;
...
let SubjectComponent = class SubjectComponent {
    ...
    uploadFile() {
        ...
        formData.append('file', file);
        file.inProgress = true;
        this.classService.addNewFileToHomework(this.main.currentClassrom.id, this.main.currentSubject.id, formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(event => {
            const index = this.files.findIndex(v => v.name === file.name);
            switch (event.type) {
    ...
    addNewHomework() {
        this.submitted = true;
        const timeUtc = moment__WEBPACK_IMPORTED_MODULE_6__(this.timeValue.nativeElement.value).toISOString();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextChatComponent", function() { return TextChatComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _core_chat_service_text_chat_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../core/chat-service/text-chat.service */ "./src/app/core/chat-service/text-chat.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _core_main_main_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../core/main/main.service */ "./src/app/core/main/main.service.ts");
...
let TextChatComponent = class TextChatComponent {
    constructor(tcService, main) {
...
TextChatComponent.ctorParameters = () => [
    { type: _core_chat_service_text_chat_service__WEBPACK_IMPORTED_MODULE_2__["TextChatService"] },
    { type: _core_main_main_service__WEBPACK_IMPORTED_MODULE_4__["MainService"] }
];
TextChatComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-text-chat',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./text-chat.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/classrom/text-chat/text-chat.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./text-chat.component.scss */ "./src/app/components/classrom/text-chat/text-chat.component.scss")).default]
    })
], TextChatComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".modal-content {\n  position: relative;\n  padding: 32px 32px 0 32px;\n  border-radius: 12px;\n}\n\n.modal-title {\n  text-align: center;\n  font-size: 35px;\n  margin-bottom: 20px;\n}\n\n.btn-primary {\n  width: 60%;\n  border-radius: 12px;\n}\n\n.transformUnder {\n  height: 50px;\n  background: var(--green);\n  border-radius: 0 0 var(--rad) var(--rad);\n  padding: 10px;\n  font-size: 20px;\n  transform: translateY(50px);\n  text-align: center;\n}\n\n.transformUnder:hover {\n  cursor: pointer;\n}\n\n.transformUnder:focus {\n  outline: none;\n}\n\noption {\n  padding: 5px !important;\n}\n\nselect {\n  border-radius: var(--rad) !important;\n}\n\n.role {\n  text-align: center;\n  font-size: 30px;\n  background: var(--negative);\n  transition: all 0.2s;\n  cursor: pointer;\n  padding: 5px;\n}\n\n@media (max-width: 992px) {\n  .role {\n    font-size: 22px;\n  }\n}\n\n.roleSelected {\n  transform: scale(1.2);\n  background: #ff7700;\n}\n\n.role1 {\n  padding-right: 10px;\n  -webkit-clip-path: polygon(0 0, 79% 0, 100% 100%, 0% 100%);\n          clip-path: polygon(0 0, 79% 0, 100% 100%, 0% 100%);\n}\n\n.role2 {\n  padding-left: 30px;\n  -webkit-clip-path: polygon(0 0, 100% 0, 100% 100%, 21% 100%);\n          clip-path: polygon(0 0, 100% 0, 100% 100%, 21% 100%);\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('showMembers')
], ShowMembersComponent.prototype, "showMembers", void 0);
ShowMembersComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-show-members',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./show-members.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/models/show-members/show-members.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./show-members.component.scss */ "./src/app/components/models/show-members/show-members.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".mainDiv {\n  background: var(--main);\n  padding: 25px;\n  -webkit-clip-path: polygon(50% 0%, 100% 0, 100% 65%, 50% 100%, 0 65%, 0 0);\n          clip-path: polygon(50% 0%, 100% 0, 100% 65%, 50% 100%, 0 65%, 0 0);\n}\n\n.cover {\n  height: 100%;\n}\n\n@media (max-width: 992px) {\n  .cover {\n    min-height: 100% !important;\n  }\n}\n\n@media (max-width: 720px) {\n  .mainDiv {\n    -webkit-clip-path: polygon(50% 0%, 100% 0, 100% 75%, 50% 100%, 0 75%, 0 0) !important;\n            clip-path: polygon(50% 0%, 100% 0, 100% 75%, 50% 100%, 0 75%, 0 0) !important;\n  }\n}\n\n.contactDetails {\n  background: #E0FBFC;\n}\n\n.rest {\n  margin-top: -150px;\n  padding-top: 150px;\n  background: var(--submit);\n}\n\n.contactUs {\n  background: #43AA8B;\n  border-top-left-radius: var(--rad);\n  border-top-right-radius: var(--rad);\n  text-align: center;\n  padding: 20px;\n  border-bottom: 2px solid black;\n}\n\n.container {\n  border-radius: var(--rad) !important;\n}\n\n.singeInfo {\n  padding: 10px;\n  margin-bottom: 3px;\n  border-bottom: 2px solid grey;\n  font-size: 35px;\n}\n\n@media (max-width: 992px) {\n  .singeInfo {\n    font-size: 25px !important;\n  }\n}\n\n.singeInfo:last-child {\n  border-bottom: none !important;\n}\n\n.infoRow {\n  margin: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".mainDiv {\n  background: var(--main);\n  padding: 25px;\n  -webkit-clip-path: polygon(50% 0%, 100% 0, 100% 65%, 50% 100%, 0 65%, 0 0);\n          clip-path: polygon(50% 0%, 100% 0, 100% 65%, 50% 100%, 0 65%, 0 0);\n}\n\n@media (max-width: 720px) {\n  .mainDiv {\n    -webkit-clip-path: polygon(50% 0%, 100% 0, 100% 75%, 50% 100%, 0 75%, 0 0) !important;\n            clip-path: polygon(50% 0%, 100% 0, 100% 75%, 50% 100%, 0 75%, 0 0) !important;\n  }\n}\n\n.contactDetails {\n  background: #E0FBFC;\n}\n\n.cover {\n  height: 100%;\n}\n\n@media (max-width: 992px) {\n  .cover {\n    min-height: 100% !important;\n  }\n}\n\n.rest {\n  margin-top: -150px;\n  padding-top: 150px;\n  background: var(--submit);\n}\n\n.contactUs {\n  background: #43AA8B;\n  border-top-left-radius: var(--rad);\n  border-top-right-radius: var(--rad);\n  text-align: center;\n  margin: 0;\n  padding: 20px;\n  border-bottom: 2px solid black;\n}\n\n.container {\n  border-radius: var(--rad) !important;\n}\n\n.singeInfo {\n  padding: 10px;\n  margin-bottom: 3px;\n  border-bottom: 2px solid grey;\n  font-size: 35px;\n}\n\n.singeInfo:last-child {\n  border-bottom: none !important;\n}\n\n@media (min-width: 720px) {\n  .infoRow {\n    border-left: 2px solid grey;\n  }\n}\n\n@media (max-width: 720px) {\n  .profilePicRow {\n    border-bottom: 2px solid grey;\n  }\n}\n\n.img-fluid {\n  border: 4px solid #F8961E;\n  border-radius: var(--rad);\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextChatService", function() { return TextChatService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _main_main_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../main/main.service */ "./src/app/core/main/main.service.ts");
/* harmony import */ var _shared_shared_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/shared.service */ "./src/app/core/shared/shared.service.ts");
...
let TextChatService = class TextChatService {
    constructor(http, main, shared) {
        this.http = http;
        this.main = main;
        this.shared = shared;
    ...
    sendMessage(messageObj) {
        return this.http.post(this.api + 'TextChat/sendMessage', messageObj).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(v => {
    ...
    getLastMessages() {
        return this.http.get(this.api + `TextChat/getLastMessages/${this.main.currentClassrom.id}/${this.main.currentSubject.id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(v => {
    ...
    getNewerMessages(messageID) {
        return this.http.get(this.api + `TextChat/getNewerMessages/${messageID}/${this.main.currentClassrom.id}/${this.main.currentSubject.id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(v => {
            if (v.messages) {
                for (let i = 0; i < v.messages.length; i++) {
                    v.messages[i].sendTime = moment__WEBPACK_IMPORTED_MODULE_6__(v.messages[i].sendTime).format('YYYY-MM-DD HH:mm:ss');
                }
    ...
    getOlderMessages(messageID) {
        return this.http.get(this.api + `TextChat/getOlderMessages/${messageID}/${this.main.currentClassrom.id}/${this.main.currentSubject.id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(v => {
            for (let i = 0; i < v.messages.length; i++) {
                v.messages[i].sendTime = moment__WEBPACK_IMPORTED_MODULE_6__(v.messages[i].sendTime).format('YYYY-MM-DD HH:mm:ss');
            }
            return v;
...
TextChatService.ctorParameters = () => [
...
TextChatService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], TextChatService);
...
let ClassService = class ClassService {
    ...
    addNewFileToHomework(classID, subjectID, fileToSend) {
