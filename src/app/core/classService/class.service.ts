...
export class ClassService {
  ...
  returnFileFromHomework(homworkData) {
    return this.http.post<HttpResponse<any>>(this.shared.apiFilesUrl + 'HomeworkFiles/returnFileFromHomework', homworkData, {headers: this.fileApiHeaders});
  }

  returnFileFromResponse(responseData): Observable<any>  {
    return this.http.post<HttpResponse<any>>(this.shared.apiFilesUrl + 'HomeworkFiles/returnFileFromResponse', responseData, {headers: this.fileApiHeaders});
  }
